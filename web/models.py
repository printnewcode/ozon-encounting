...
class SaleRecord(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='sales', verbose_name="Связанный товар")
    ...
    def save(self, *args, **kwargs):
        # Автоматическое дублирование артикула и названия из товара (для истории)
        if self.product:
